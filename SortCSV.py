...
# --- 1. Input CSV dan folder tujuan utama ---
csv_file = r"D:\LearnPython\Tools_labeler\df_NamaFile.csv"
output_root = r"C:\Users\Aldan\Desktop\ImproTYT\90%good"  # <- Ganti ke folder tujuanmu
...
# 3. Ambil baris dengan objek terbanyak untuk setiap gambar
best_per_file = df[df['Jumlah Objek'] > 16].sort_values("Jumlah Objek", ascending=False).drop_duplicates(subset=["Path Gambar"])
print(best_per_file.describe())
# print(best_per_file['Jumlah Objek'].unique())
